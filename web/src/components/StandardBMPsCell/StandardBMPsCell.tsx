import type { FindStandardBmpsQuery, FindStandardBmpsQueryVariables } from 'types/graphql'
...
export const Failure = ({ error }: CellFailureProps<FindStandardBmpsQueryVariables>) => (
  <div style={{ color: 'red' }}>Error: {error?.message}</div>
)

export const Success = ({ standardBmps }: CellSuccessProps<FindStandardBmpsQuery, FindStandardBmpsQueryVariables>) => {
  return (
    <ul className="mt-4">
